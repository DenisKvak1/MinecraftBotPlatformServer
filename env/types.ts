import { HeadRotateDirection } from '../src/infrastructure/services/HeadService';
import { MovementDirection } from '../src/infrastructure/services/WalkService';
import { Item } from 'prismarine-item';
import { AccountModel } from '../src/core/model/AccountModel';
...
export type OutgoingConnecingBotMessage = {
    command: OUTGHOING_COMMAND_LIST.CONNECTING_BOT
    id: string,
    state: "CONNECTED" | "DISCONNECTED" | "SPAWN"
}
export type OutgoingOpenWindowBotMessage = {
